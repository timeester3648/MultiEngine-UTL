...
TEST_CASE("Parallel-for (Range) / Detached block loop") {
    repeat(repeats, [] {
...
TEST_CASE("Parallel-for (Range) / Detached iteration loop") {
    repeat(repeats, [] {
        std::vector<int> vec(N, 0);
...
TEST_CASE("Parallel-for (Range) / Blocking block loop") {
    repeat(repeats, [] {
        std::vector<int> vec(N, 0);
...
TEST_CASE("Parallel-for (Range) / Blocking iteration loop") {
    repeat(repeats, [] {
        std::vector<int> vec(N, 0);
...
TEST_CASE("Parallel-for (Range) / Awaitable block loop") {
    repeat(repeats, [] {
        std::vector<int> vec(N, 0);
...
TEST_CASE("Parallel-for (Range) / Awaitable iteration loop") {
    repeat(repeats, [] {
        std::vector<int> vec(N, 0);
